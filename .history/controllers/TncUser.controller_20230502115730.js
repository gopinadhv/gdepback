       ...
       <p>8.Users acknowledges that this service is available only within the service area where indicated SSID Free Airport Wi-Fi by NT.</p>
        ...
        `;
                ...
                var options = {
                    ...
                    "orientation": "portrait",
                    "header": {
                        "contents": "<img src='../views/images/tc.png' />",
                        "height": "30mm"
                    },
                    "margin": '0.5cm'
                }
                ...
                phantom.create().then(function (ph) {
                    ph.createPage({ format: 'A4', orientation: 'portrait', header: { 'contents': '<img src="../views/images/tc.png" />', 'height': '30mm' } }).then(function (page) {
